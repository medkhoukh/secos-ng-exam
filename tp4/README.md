...
**Q7\* : Avant d'activer la pagination, on souhaiterait faire en sorte que
  ...
  cet exo sert à faire en sorte que deux processus aient une mémoire partagée, sans avoir la même pgd. le seul point commun sera que les PGT pointerons vers les mêmes adresses, sinon tous les autres indexs changent.

  il faut transformer 0xc00000000 en binaire et trouver p, b et d dans l'ordre
  p c'est les 12 premiers bits de poids faible
  b 10 bits suivants
  d c'est les 10 bits restants
  on trouve dans cet exemple que : d=0x300
  b=0x0 et p=0x0
  **
